...
void main() {
  group('Simple Performance Tests', () {
    testWidgets('App loads with performance optimizations', (WidgetTester tester) async {
      ...
      expect(find.byKey(const ValueKey('canvas_gesture_detector')), findsOneWidget);
    });
    ...
    testWidgets('DotPainter shouldRepaint optimization works', (WidgetTester tester) async {
    ...
    testWidgets('Clear button is present and accessible', (WidgetTester tester) async {
      await tester.pumpWidget(const DrillDrawApp());
    ...
    testWidgets('Widget structure is optimized', (WidgetTester tester) async {
      ...
      expect(find.byType(CustomPaint), findsWidgets); // May be multiple due to Flutter internals
      expect(find.byType(RepaintBoundary), findsWidgets);
    });

    testWidgets('Performance optimizations survive rebuilds', (WidgetTester tester) async {
      await tester.pumpWidget(const DrillDrawApp());
