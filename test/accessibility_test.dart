...
void main() {
  group('DrillDraw Accessibility Tests', () {
    ...
    testWidgets('Info panel has live region for dot count', (WidgetTester tester) async {
      await tester.pumpWidget(const DrillDrawApp());
      ...
      final liveRegionFinder = find.byWidgetPredicate((widget) {
        return widget is Semantics && 
               widget.properties.liveRegion != null;
      });
    ...
    testWidgets('Keyboard shortcuts work for clearing dots', (WidgetTester tester) async {
      await tester.pumpWidget(const DrillDrawApp());
    ...
    testWidgets('App supports keyboard navigation', (WidgetTester tester) async {
      await tester.pumpWidget(const DrillDrawApp());
