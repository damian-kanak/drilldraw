...
#ifndef DRILLDRAW_SWIFT_H
#define DRILLDRAW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="drilldraw",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC9drilldraw11AppDelegate")
...
SWIFT_CLASS("_TtC9drilldraw17MainFlutterWindow")
